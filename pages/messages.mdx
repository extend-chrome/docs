...
<Image
  ...
  alt="@extend-chrome/messages logo"
/>
...
<p>
  <Badge
    alt="npm (scoped)"
    href="https://www.npmjs.com/package/@extend-chrome/messages"
    src="https://img.shields.io/npm/v/@extend-chrome/messages.svg"
  ></Badge>
  <Badge
    alt="GitHub"
    href="https://github.com/extend-chrome/messages"
    src="https://img.shields.io/github/last-commit/extend-chrome/messages.svg"
  ></Badge>
  <Badge
    alt="License"
    href="https://github.com/extend-chrome/messages/blob/master/LICENSE"
...
Version 0.5.0 introduces [`getScope`](#getscope), a way to use a separate
messaging space.
