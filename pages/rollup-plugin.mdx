...
Just follow the [migration guide](https://developer.chrome.com/docs/extensions/mv3/intro/mv3-migration/), setting `manifest_version` to `3`, and we've got your back! No additional Rollup configuration required.
